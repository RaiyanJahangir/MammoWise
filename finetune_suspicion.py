...
dataset_path = "/mnt/data/raiyan00/breast_cancer/MedGemma/dataset_dict/malignancy_dataset_dict"  # Replace this with the dataset dict folder
...
args = SFTConfig(
    output_dir="/mnt/data/raiyan00/breast_cancer/MedGemma/model_weights/model_weights_malignancy",  # still needed locally
    ...
    push_to_hub=True,
    hub_model_id="RaiyanJahangir/medgemma-malignancy-6epoch",
